...
ALLOWED_HOSTS = ['coffeecollectionbcs.herokuapp.com', 'localhost', '127.0.0.1']
...
MEDIA_URL = 'images/'
MEDIA_ROOT = os.path.join(BASE_DIR, '/var/www/static/images')
...
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = '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'
